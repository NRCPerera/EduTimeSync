...
import { Menu, Bell, User, LogOut, Settings, ChevronDown, BookOpen, Users, Home, LayoutDashboard } from 'lucide-react';
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-2">
              ...
              <div className="text-xs text-indigo-200">Smarter Scheduling, Seamless Learning</div>
            </div>
          </div>
