...
import { Menu, Bell, User, LogOut, Settings, ChevronDown, BookOpen, Calendar, Home, LayoutDashboard, GraduationCap } from 'lucide-react';

export default function ExaminerHeader() {
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-2">
              ...
              <div className="text-xs text-amber-200">Smarter Scheduling, Seamless Learning</div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button 
                ...
                className="flex items-center space-x-2 hover:text-amber-200"
              >
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 text-gray-700">
                  <a href="#" className="block px-4 py-2 hover:bg-amber-50 flex items-center gap-2">
                    <Settings className="h-4 w-4" />
                    Settings
                  </a>
                  <a href="/sign-in" className="block px-4 py-2 hover:bg-amber-50 flex items-center gap-2">
